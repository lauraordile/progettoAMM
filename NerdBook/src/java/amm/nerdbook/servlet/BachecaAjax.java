...
public class BachecaAjax extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (command != null) 
        {
            ...
            if (command.equals("search")) 
            {
                ...
                // Esegue la ricerca
                List<UtenteRegistrato> listaUtenti = UtentiregistratiFactory.getInstance()
                        .getListaUtenti(request.getParameter("nomeGattoCercato"));
